...
public class ExchangeController {
    ...
    public SuccessResponse<List<AccountListDTO>> getAccountList(@RequestParam Long userId) {
        return SuccessResponse.success(SuccessCode.FIND_ACCOUNTS_LIST_SUCCESS, ExchangeRateservice.getAccountList(userId));
    }
    ...
    public SuccessResponse<ExchangeBalanceDTO> getRatesAndBalance(@RequestParam String userId, @RequestParam String currencyCode, @RequestParam String accountId) {
